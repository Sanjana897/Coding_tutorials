...
> 2
How many bars of candy did you ell?
> 32
How much did you sell each bar for?
> 2
After selling 32 candy bars, your total profit is $24.00.
"""
boxes_bought = int(input('How many boxes of candy bars did you buy?\n'))
bars_sold = int(input('How many bars of candy did you sell?\n'))
price = int(input('How much did you sell each bar for?\n'))
profit = (bars_sold*price)-(boxes_bought*20)
profit1 = str(profit)
print('Your current profit is $'+profit1)
