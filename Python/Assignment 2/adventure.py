...
#Step 2
print(name, end=" ")
occupation = input('are you a Warrior, Wizard or Programmer?')
...
#Steps 4 and 5
if len(full_name) <= 15:
    print('.xX WELCOME', full_name, 'Xx.')
else:
    print('Welcome', occupation)

#Steps 6, 7 and 8
if occupation == 'Programmer':
    print("There is no treasure here for you. The real treasure is the time spent programming.")
elif occupation == 'Wizard' or occupation == 'Warrior':
    print("You're in a dimly lit room, standing in front of an enormous steel chest.")
else:
    print("Come back when you have a real job!")

#Step 9
open_or_close = input('Do you want to open the chest or leave the room?')

#Step 10
if open_or_close == 'open' or open_or_close == 'OPEN' or open_or_close == 'Open':
    import random
    choice = random.randint(1, 20)

#Step 11
elif open_or_close == 'leave' or open_or_close == 'LEAVE' or open_or_close == 'Leave':
    print('Nothing happens. Well, what did you expect?')
...
if choice >= 1 and choice <= 5:
    print('A tiny lemur comes out and bites you. Do lemurs have rabies? Better find out!')
elif choice >= 6 and choice <= 10:
    print('Today is not your day.')
elif choice >= 10 and choice <= 15:
    print('A tiny lemur comes out and blows you a kiss.')
else:
    print('A tiny lemur comes out and declares you the ruler of lemur-world! Yes, that is a real kingdom.')
